    ...
    private void initViews() {
        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String output = getString(R.string.IsCheckedChkBx, string);
                Toast.makeText(CheckBoxActivity.this, output , Toast.LENGTH_LONG).show();
            }
        });
    }
